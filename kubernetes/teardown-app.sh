kubectl delete -f ./minikube/k8s-beyondewallet-app-fabric.yaml
kubectl delete -f ./minikube/k8s-beyondewallet-app-middleware.yaml
kubectl delete -f ./minikube/k8s-beyondewallet-app-frontend.yaml
kubectl delete -f ./minikube/k8s-http-load-balancer.yaml
