...
kubectl apply -f ./minikube/k8s-beyondewallet-app-fabric.yaml
kubectl apply -f ./minikube/k8s-beyondewallet-app-middleware.yaml
kubectl apply -f ./minikube/k8s-beyondewallet-app-frontend.yaml
