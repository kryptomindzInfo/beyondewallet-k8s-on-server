...
git submodule update --merge --remote ../fabric-network/ewallet-cc/
...
peer chaincode upgrade -o siliconvalley-orderer-clusterip:30750 -C $CC_CHANNEL_ID -n $CC_NAME  -v $1 -c "{\"Args\":[]}" --tls --cafile $ORDERER_CA' _ $VER
